...
usrp = uhd.usrp.MultiUSRP("addr="+usrp_addr+", master_clock_rate=100e6")
...
tx_buffer[0, :] = 0
tx_buffer[0, int(round(tx_gap_prefix_times[i_set]*samp_rate)):nticks_txb-int(round(tx_gap_postfix_time*samp_rate))] = 0.92
